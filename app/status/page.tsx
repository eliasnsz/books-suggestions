      ...
      <>
        ...
        <section className="my-4 space-y-2">
          ...
          <ul className="text-sm space-y-2">
            <StatusBadge label="Status" data={data.status} />
            <DefaultBadge
            ...
            <LatencyBadges
              latencyFirstValue={
                data.dependencies.database.first_query_duration_in_miliseconds
              }
              latencySecondValue={
                data.dependencies.database.second_query_duration_in_miliseconds
              }
              latencyThirdValue={
                data.dependencies.database.third_query_duration_in_miliseconds
              }
            />
          </ul>
        </section>
